...
// Mount payment protection at the root so middleware sees full /v1/... paths.
...
app.get('/', (_req, res) => {
  res.json({
    ...
    payTo: AVM_ADDRESS,
    endpoints: {
      'POST /v1/chat': '$0.005 - LLM chat completions (Groq auto-routing + explicit model selection)',
      'GET /v1/chat/models': 'Public - List available Groq chat models',
...
try {
  app.listen(port, host, () => {
    ...
    console.log('\n   Routes: /v1/chat | /v1/chat/models | /v1/stt | /v1/tts | /v1/image | /v1/storage | /v1/compute | /v1/hf | /v1/search | /v1/weather\n');
  });
